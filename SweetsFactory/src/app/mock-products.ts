...
export const PRODUCTS: Product[] = [
    { id: 55, name: "Vanilla Ice cream", category: 1, price: 20, stock: 10, img: "../icecream.png" },
    { id: 25, name: "Chocolate Ice cream", category: 1, price: 22, stock: 22, img: "../images/icecream.png" },
